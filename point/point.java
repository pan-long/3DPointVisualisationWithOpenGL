...
public class point implements Comparable<point>
{
    ...
    public point(float x, float y, float z, float normal_x, float normal_y, float normal_z)
    {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    {
        if (properties == null)
            properties = new float[] {this.x, this.y, this.z, this.normal_x, this.normal_y, this.normal_z};
        return properties;
    }
    @Override
    ...
    public float disTo(point other)
    {
        if (other == null)
            ...
            return (float)Math.sqrt((this.x - other.getX()) * (this.x - other.getX()) + (this.y - other.getY()) * (this.y - other.getY()) + (this.z - other.getZ()) * (this.z - other.getZ()));
    }
}
